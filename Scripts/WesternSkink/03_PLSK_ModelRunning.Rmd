...
list.of.packages <- c("tidyverse", "lubridate","chron","bcdata", "bcmaps","sf", "rgdal", "readxl", "Cairo", "wetlandmapR", "ggmap","rgbif","stars")
...
rastLUT_text <- read.csv(file.path("~/DataAnalysis/SHM22.0253/bc-cdc-species-habitat-modelling/scripts",'rastLUT.csv'),
                     header = FALSE,
...
r <- raster::raster('R:/22.0253_SHM_Year2/Worked_Examples/Western_Skink/Outputs/20230307-162207/20230307-162207_map.img')
plot(r)
plot(PLSK_sp, add=TRUE)

r <- raster::raster('R:/22.0253_SHM_Year2/Worked_Examples/Coastal_Tailed_Frog/Outputs/20230307-141136/20230307-141136_map.img')
#---------------------------------------
#---------------------------------------
#---------------------------------------
#---------------------------------------
...
r <- raster('R:/22.0253_SHM_Year2/Worked_Examples/Western_Skink/Outputs/20230222-130736/20230222-130736_map.img')
